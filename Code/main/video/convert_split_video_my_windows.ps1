...
#ffmpeg -y -i $VIDEO -c:a aac -ac 2 -ab 128k -c:v libx264 -x264opts keyint=48:min-keyint=48:no-scenecut -b:v 250k -maxrate 500k -bufsize 1000k -s 426x240 -vf scale=426x240 -filter:v fps=25 video_240_25fps.mp4
#ffmpeg -y -i $VIDEO -c:a aac -ac 2 -ab 128k -c:v libx264 -x264opts keyint=48:min-keyint=48:no-scenecut -b:v 400k -maxrate 800k -bufsize 1600k -s 640x360 -vf scale=640x360 -filter:v fps=25 video_360_25fps.mp4
#ffmpeg -y -i $VIDEO -c:a aac -ac 2 -ab 128k -c:v libx264 -x264opts keyint=48:min-keyint=48:no-scenecut -b:v 500k -maxrate 1000k -bufsize 2000k -s 854x480 -vf scale=854:480 -filter:v fps=25 video_480_25fps.mp4
#ffmpeg -y -i $VIDEO -c:a aac -ac 2 -ab 128k -c:v libx264 -x264opts keyint=48:min-keyint=48:no-scenecut -b:v 1500k -maxrate 3000k -bufsize 6000k -s 1280x720 -vf scale=1280:720 -filter:v fps=25 video_720_25fps.mp4
...
#ffmpeg -y -i $VIDEO -c:a aac -ac 2 -ab 128k -c:v libx264 -x264opts keyint=48:min-keyint=48:no-scenecut -b:v 3000k -maxrate 6000k -bufsize 12000k -s 1920x1080 -vf scale=1920:1080 -filter:v fps=25 video_1080_25fps.mp4
...
#ffmpeg -y -i $VIDEO -c:a aac -ac 2 -ab 128k -c:v libx264 -x264opts keyint=48:min-keyint=48:no-scenecut -b:v 6000k -maxrate 12000k -bufsize 24000k -s 2560x1440 -vf scale=2560:1440 -filter:v fps=25 video_1440_25fps.mp4
#ffmpeg -y -i $VIDEO -c:a aac -ac 2 -ab 128k -c:v libx264 -x264opts keyint=96:min-keyint=96:no-scenecut -b:v 10000k -maxrate 20000k -bufsize 40000k -s 2560x1440 -vf scale=2560:1440 -filter:v fps=60 video_1440_60fps.mp4
#ffmpeg -y -i $VIDEO -c:a aac -ac 2 -ab 128k -c:v libx264 -x264opts keyint=48:min-keyint=48:no-scenecut -b:v 15000k -maxrate 30000k -bufsize 60000k -s 3840x2160 -vf scale=3840:2160 -filter:v fps=25 video_2160_25fps.mp4
#ffmpeg -y -i $VIDEO -c:a aac -ac 2 -ab 128k -c:v libx264 -x264opts keyint=96:min-keyint=96:no-scenecut -b:v 20000k -maxrate 40000k -bufsize 80000k -s 3840x2160 -vf scale=3840:2160 -filter:v fps=60 video_2160_60fps.mp4
...
-fps 25 video_1440_25fps.mp4`#video:id=1440p `
-fps 60 video_1440_60fps.mp4`#video:id=14402p `
-fps 25 video_2160_25fps.mp4`#video:id=2560p `
