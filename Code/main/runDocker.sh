...
docker run -it --rm --privileged -p 2223:22 -e DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix -v /lib/modules:/lib/modules -v $(pwd):/data $(docker build -t mininet-rl -q .) #this works within wsl
