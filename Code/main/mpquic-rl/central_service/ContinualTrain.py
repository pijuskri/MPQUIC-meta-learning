...
from avalanche_rl.models.dqn import EWCConvDeepQN, MLPDeepQN
...
from avalanche_rl.evaluation.metrics.reward import GenericFloatMetric, ReturnPluginMetric
...
if __name__ == "__main__":
    ...
    env = gym.make('NetworkEnv') #customGym:NetworkEnv
    scenario = gym_benchmark_generator(environments = [env])
    ...
    ewc_penalty_metric = ReturnPluginMetric(100)
    ...
    strategy = DQNStrategy(
        ...
        plugins=[HalveEps()], rollouts_per_step = 1,
