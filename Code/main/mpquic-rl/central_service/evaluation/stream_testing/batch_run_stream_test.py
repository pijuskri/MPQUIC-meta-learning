...
#TOPOS_FP = 'central_service/environment/topos.json'
#GRAPHS_FP = 'central_service/environment/test_graphs.json'
TOPOS_FP = '../../environment/topos.json'
GRAPHS_FP = '../../environment/test_graphs.json'
TG_PAIRS = ['lol.txt']
