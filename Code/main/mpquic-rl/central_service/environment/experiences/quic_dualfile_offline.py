...
from ...variables import REMOTE_SERVER_RUNNER_HOSTNAME, REMOTE_SERVER_RUNNER_PORT
        ...
        def testsMultipath(**kwargs):
            def test(**kwargs):
                xpDict = {
                    ...
                    JSON_FILE: "",   # specify websites to download
...
def launchTests(times=1):
    mptcpTopos = [
        ...
        'paths': [  
                    {'queuingDelay': '0', 'delay': '5.000000', 'bandwidth': '100'}, 
                    {'queuingDelay': '0', 'delay': '5.000000', 'bandwidth': '25'}
                ]
        }
    ]
